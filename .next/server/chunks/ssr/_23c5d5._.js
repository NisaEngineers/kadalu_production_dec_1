...
;
// ---------------------------------------------------------------------------
// 1. PUBLIC NGROK URL – change only this line if the tunnel changes
// ---------------------------------------------------------------------------
...
function PremiumSplitterClient() {
    ...
    // -----------------------------------------------------------------------
    // 3. Split request – now uses the public ngrok URL
    // -----------------------------------------------------------------------
    const handleSplit = async ()=>{
        ...
        try {
            ...
            // Build absolute URLs for every stem
            const urls = {};
            data.files.forEach((path)=>{
                const filename = path.split("/").pop();
                urls[filename] = `${API_BASE}${path}`;
            });
            setVocalAudioURL(urls["vocals.wav"]);
            setDrumsAudioURL(urls["drums.wav"]);
            setGuitarAudioURL(urls["guitar.wav"]);
            setPianoAudioURL(urls["piano.wav"]);
            setBassAudioURL(urls["bass.wav"]);
            setOtherAudioURL(urls["strings_or_pads.wav"]);
        } catch (err) {
            console.error(err);
    ...
    // -----------------------------------------------------------------------
    // 4. Playback / volume helpers (unchanged, just duplicated for each stem)
    // -----------------------------------------------------------------------
    const toggle = (ref, playing, setPlaying, paused, setPaused, volume, setVolume)=>{
    ...
    const changeVolume = (ref, value, setVolume, setPlaying, setPaused)=>{
        setVolume(value);
        if (ref.current) {
    ...
    // -----------------------------------------------------------------------
    // 5. UI (identical to the original – only the button text changed)
    // -----------------------------------------------------------------------
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "jsx-d12fb532fe845fa5" + " " + "relative min-h-screen overflow-hidden",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("video", {
                ...
                loop: true,
                muted: true,
                className: "jsx-d12fb532fe845fa5" + " " + "absolute top-0 left-0 w-full h-full object-cover"
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-d12fb532fe845fa5" + " " + "absolute top-0 left-0 w-full h-full bg-black opacity-50"
            }, void 0, false, {
                fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                lineNumber: 173,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-d12fb532fe845fa5" + " " + "relative z-10 text-white",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "jsx-d12fb532fe845fa5" + " " + "container mx-auto px-4 sm:px-6",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-d12fb532fe845fa5" + " " + "py-12 md:py-20",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-d12fb532fe845fa5" + " " + "pb-12 text-center",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        className: "jsx-d12fb532fe845fa5" + " " + "text-4xl font-bold md:text-5xl text-green-300",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "jsx-d12fb532fe845fa5" + " " + "text-lg mt-4 text-gray-300 max-w-3xl mx-auto",
                                    ...
                                    error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-d12fb532fe845fa5" + " " + "mt-4 p-3 bg-red-800/50 rounded-lg text-red-300",
                                        children: [
                                            "Error: ",
                                            error
                                        ]
                            ...
                            !uploaded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                className: "jsx-d12fb532fe845fa5" + " " + "mx-auto max-w-md bg-transparent",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-d12fb532fe845fa5" + " " + "space-y-5",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-d12fb532fe845fa5" + " " + "relative",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                required: true,
                                                className: "jsx-d12fb532fe845fa5" + " " + "w-full h-12 opacity-0 cursor-pointer"
                                            }, void 0, false, {
                                                fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                                lineNumber: 197,
                                                columnNumber: 21
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "jsx-d12fb532fe845fa5" + " " + "absolute inset-0 flex items-center justify-center border-2 border-dashed border-gray-500 rounded-lg bg-transparent pointer-events-none",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "jsx-d12fb532fe845fa5" + " " + "text-gray-200 opacity-80",
                                                    children: [
                                                        "Click to Choose a File",
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "jsx-d12fb532fe845fa5" + " " + "text-red-500",
                                                            children: "*"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                                            lineNumber: 207,
                                ...
                                className: "jsx-d12fb532fe845fa5" + " " + "mt-6",
                                children: !splitting ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-d12fb532fe845fa5" + " " + "text-center",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: handleSplit,
                                        className: "jsx-d12fb532fe845fa5" + " " + "px-6 py-3 bg-gradient-to-r from-green-400 to-blue-500 text-white font-semibold rounded shadow hover:from-green-500 hover:to-blue-600 transition-all duration-300",
                                    ...
                                    className: "jsx-d12fb532fe845fa5" + " " + "flex justify-center mt-6",
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "jsx-d12fb532fe845fa5" + " " + "flex items-center space-x-2 text-white",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "jsx-d12fb532fe845fa5" + " " + "loader-dot"
                                            }, void 0, false, {
                                                fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                                lineNumber: 227,
                                                columnNumber: 23
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "jsx-d12fb532fe845fa5",
                                                children: "Processing..."
                                            }, void 0, false, {
                                                fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                                lineNumber: 230,
                            ...
                            uploaded && !splitting && vocalAudioURL && drumsAudioURL && guitarAudioURL && pianoAudioURL && bassAudioURL && otherAudioURL && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "jsx-d12fb532fe845fa5" + " " + "mt-10 space-y-12",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        setIsPaused: setIsOriginalPaused,
                                        volume: originalVolume,
                                        setVolume: setOriginalVolume,
                                        downloadName: "original_audio",
                                        className: "jsx-d12fb532fe845fa5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                        lineNumber: 241,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        setIsPlaying: setIsPlayingVocal,
                                        isPaused: isVocalPaused,
                                        setIsPaused: setIsVocalPaused,
                                        volume: vocalVolume,
                                        setVolume: setVocalVolume,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        isPaused: isDrumsPaused,
                                        setIsPaused: setIsDrumsPaused,
                                        volume: drumsVolume,
                                        setVolume: setDrumsVolume,
                                        downloadName: "drums.wav",
                                        className: "jsx-d12fb532fe845fa5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                        lineNumber: 269,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        isPaused: isGuitarPaused,
                                        setIsPaused: setIsGuitarPaused,
                                        volume: guitarVolume,
                                        setVolume: setGuitarVolume,
                                        downloadName: "guitar.wav",
                                        className: "jsx-d12fb532fe845fa5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                        lineNumber: 283,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        isPaused: isPianoPaused,
                                        setIsPaused: setIsPianoPaused,
                                        volume: pianoVolume,
                                        setVolume: setPianoVolume,
                                        downloadName: "piano.wav",
                                        className: "jsx-d12fb532fe845fa5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                        lineNumber: 297,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AudioBlock, {
                                        ...
                                        isPaused: isBassPaused,
                                        setIsPaused: setIsBassPaused,
                                        volume: bassVolume,
                                        setVolume: setBassVolume,
                                        downloadName: "bass.wav",
                                        className: "jsx-d12fb532fe845fa5"
                                    }, void 0, false, {
                                        fileName: "[project]/app/services/PremiumSplitter/PremiumSplitterClient.tsx",
                                        lineNumber: 311,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "d12fb532fe845fa5",
                children: ".control-container.jsx-d12fb532fe845fa5{background:linear-gradient(135deg,#1a1b26,#16161e);border-radius:12px;padding:1.5rem;box-shadow:0 8px 32px #0000001a}.waveform.jsx-d12fb532fe845fa5{align-items:flex-end;gap:4px;width:fit-content;height:40px;margin:1rem auto 0;display:flex}.bar.jsx-d12fb532fe845fa5{transform-origin:bottom;background:linear-gradient(#ec4899,#6366f1);border-radius:3px;width:120px;animation:.8s ease-in-out infinite pulse}.bar.jsx-d12fb532fe845fa5:first-child{height:18px;animation-delay:.1s}.bar.jsx-d12fb532fe845fa5:nth-child(2){height:22px;animation-delay:.2s}.bar.jsx-d12fb532fe845fa5:nth-child(3){height:16px;animation-delay:.3s}.bar.jsx-d12fb532fe845fa5:nth-child(4){height:24px;animation-delay:.4s}.bar.jsx-d12fb532fe845fa5:nth-child(5){height:14px;animation-delay:.5s}@keyframes pulse{0%,to{transform:scaleY(.6)}50%{transform:scaleY(1.4)}}.loader-dot.jsx-d12fb532fe845fa5{background:#ddd;border-radius:50%;width:10px;height:10px;animation:1s infinite alternate loader}@keyframes loader{to{background:#ec4899;transform:scale(1.5)}}.slider-thumb.jsx-d12fb532fe845fa5::-webkit-slider-thumb{background:linear-gradient(45deg,#6366f1,#ec4899);border:2px solid #fff;width:16px;height:16px}"
    ...
    // -----------------------------------------------------------------------
    // 6. Re-usable audio block (keeps the file tidy)
    // -----------------------------------------------------------------------
    function AudioBlock({ title, src, ref, isPlaying, setIsPlaying, isPaused, setIsPaused, volume, setVolume, downloadName }) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>toggle(ref, isPlaying, setIsPlaying, isPaused, setIsPaused, volume, setVolume),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ...
                                    max: "100",
                                    value: volume,
                                    onChange: (e)=>changeVolume(ref, Number(e.target.value), setVolume, setIsPlaying, setIsPaused),
                        ...
                        isPlaying && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "waveform mt-4 flex items-center justify-center gap-4",
                            children: [
                                ...Array(5)
...
//# sourceMappingURL=_23c5d5._.js.map