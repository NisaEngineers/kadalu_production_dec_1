...
(()=>{
    const e = new Error("Cannot find module 'sqlite'");
...
async function POST(req) {
    try {
        ...
        await db.run("INSERT INTO users (name, email, password_hash) VALUES (?, ?, ?)", name, email, password_hash);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__63e593._.js.map