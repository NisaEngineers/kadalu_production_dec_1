...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    } else if (status === "authenticated" && session?.user?.email !== "admin@monaarch.org") {
  ...
  if (!session || session.user?.email !== "admin@monaarch.org") {
    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="space-y-16">
              ...
              <table className="min-w-full bg-white border border-gray-200">
                <thead>
                  <tr className="bg-gray-200">
                    ...
                    <th className="py-2 px-4 border-b text-right">Usage (hrs)</th>
                    <th className="py-2 px-4 border-b text-right">Expenditure ($)</th>
        ...
        <section className="p-8 bg-white rounded-xl shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-medium mb-2">Optimization Scores</h3>
              <div className="h-64">
                <Bar
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-2">Recommendation Overview</h3>
              <p className="text-gray-700">
                Based on a hybrid approach using KNN and KMeans algorithms, our system recommends targeted marketing strategies to boost revenue, optimize user engagement, and improve retention.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="p-8 bg-white rounded-xl shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-medium mb-2">Overall Performance Metrics</h3>
              <div className="h-64">
                <Bar
                  data={llmReportData}
                  options={{ maintainAspectRatio: false, responsive: true }}
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-2">Summary Report</h3>
              <p className="text-gray-700">
                The LLM report consolidates analytics and machine learning insights to form a comprehensive summary.
              </p>
            </div>
          </div>
        </section>
