...
export default function VocalRemoverClient() {
  ...
  const handleRemoveVocals = async () => {
    ...
    try {
      ...
      const baseUrl = "https://api-vocal.monaarch.org";
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      <video className="absolute top-0 left-0 w-full h-full object-cover" src="/Vocal_BG.mp4" autoPlay loop muted />
      <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50"></div>
      <div className="relative z-10 text-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            <div className="pb-12 text-center">
              <h1 className="text-4xl font-bold md:text-5xl text-green-300">Voice Remover</h1>
              ...
              <div className="mt-10 space-y-12">
                ...
                <div className="p-6 rounded-lg border-2 border-dashed border-gray-500 bg-transparent">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {isPlayingVocal && <Waveform />}
                    <audio ref={vocalAudioRef} src={vocalAudioURL} onEnded={() => setIsPlayingVocal(false)} />
                    <div className="mt-6 flex justify-center">
                      <a
                        href={vocalAudioURL}
                        download="vocals.mp3"
                ...
                {/* Instrumental */}
                <div className="p-6 rounded-lg border-2 border-dashed border-gray-500 bg-transparent">
                  <h2 className="text-xl font-semibold mb-4 text-center">Instrumental</h2>
                  <div className="flex flex-col items-center">
                    <div className="flex items-center space-x-4">
                      <button
                    ...
                    {isPlayingInstrumental && <Waveform />}
                    <audio ref={instrumentalAudioRef} src={instrumentalAudioURL} onEnded={() => setIsPlayingInstrumental(false)} />
                    <div className="mt-6 flex justify-center">
                      <a
